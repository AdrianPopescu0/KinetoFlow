...
| Rută | Rol |
| --- | --- |
| `/` | Landing de prezentare. Butoane către `/login` (autentificare) și înregistrare clinică. Jos, înainte de subsol: **Întrebări frecvente** (acordeon). Fără cumpărare abonament. |
