...
| Rută | Rol |
| --- | --- |
| `/` | Landing de prezentare. Buton **Setări** în antet: temă Dark/Light, limbă (RO/EN pentru meniu), contact `contact@kinetoflow.ro`, suport, autentificare și acces pacient. Hero foto + secțiuni care urmează tema. |
