...
export function LandingHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-slate-50/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-3 px-4 sm:h-[4.25rem] sm:px-6">
        ...
        <Link
          href="/login"
          prefetch
          className={cn(buttonVariants(), "h-11 min-h-[44px] rounded-xl px-4 sm:px-5")}
        >
          Intră în cont
        </Link>
      </div>
