...
export function PatientPortal({ program }: PatientPortalProps) {
  ...
  return (
    <div className="min-h-full bg-[#F3F6F7] text-[#0F4C5C]">
      <PatientHeader
      ...
      <main className="mx-auto flex w-full max-w-lg flex-col gap-8 px-4 py-6 pb-16">
        <section className="flex flex-col gap-4">
          <div>
            <h2 className="text-lg font-semibold tracking-tight">Exercițiile tale de azi</h2>
        ...
        {!isClient ? (
          <div className="h-80 animate-pulse rounded-2xl bg-white/80" aria-hidden="true" />
        ) : storedCheckin ? (
